...
I'm a Fulbright Scholar at the University of Southern California pursuing my Master's in Computer Science, where I work with Prof. [Nanyun Peng](https://violetpeng.github.io/) and Prof. [Emilio Ferrara](http://www.emilio.ferrara.name/) at the [USC Information Sciences Institute](https://isi.edu/). My work primarily focuses on leveraging unsupervised and transfer learning for natural language processing and computational social science in low-resource settings. I also serve as President of [GRIDS](https://www.linkedin.com/company/grids/), USC's student data science organization.
...
My paper on Urdu Word Embeddings was published at LREC 2018. [PDF](http://www.lrec-conf.org/proceedings/lrec2018/pdf/148.pdf).

I gave a talk and tutorial on deep learning with Python at PyCon Pakistan 2017. [Slides](https://pycon.pk/static/media/uploads/presentations/samar_haider_pycon_talk.pdf).

I gave a talk titled "Improving NLP for Low-resource Languages Using Word Embeddings" at the University of San Francisco's Seminar Series in Analytics. [Link](https://www.meetup.com/USF-Seminar-Series-in-Analytics/events/237769358/).

My work on training Urdu word embeddings was mentioned in a Forbes story on the impact of democratizing artificial intelligence on the developing world. [Link](https://www.forbes.com/sites/mariyayao/2017/04/10/why-we-need-to-democratize-ai-machine-learning-education/).

I received a mention in Andrew Ng's #LearnML challenge on the Coursera Blog. [Link](https://blog.coursera.org/andrew-ng-announces-winners-of-learnml-contest/).
...
[[Dataset](https://github.com/samarh/soccerdata)][Report]
...
[[Code](https://github.com/samarh/alpr)][Report]
