...
I'm a PhD student in the Department of Computer and Information Science at the University of Pennsylvania, where I am advised by [Duncan J. Watts](https://duncanjwatts.com/) and [Chris Callison-Burch](https://www.cis.upenn.edu/~ccb/). My research interests are at the intersection of computational social science and natural language processing, with a focus on using large language models to study bias in the mainstream media. I am part of the [Penn Media Accountability Project](https://css.seas.upenn.edu/project/penn-map/) and the scientific lead of the [Media Bias Detector](https://mediabiasdetector.seas.upenn.edu/).
