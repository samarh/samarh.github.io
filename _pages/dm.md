...
On a final note, thank you all for being a part of this class.

I hope this course helped demystify how so many of the 'intelligent' apps and services we use everyday function at their core. The purpose of this course was not to to teach you every kind of machine learning algorithm out there but to provide you with a solid foundation of the principles of machine learning and show just how intuitive it can be if you take away all the mathematical complexity.

If this course inspired you to pursue machine learning/data science further, then you might want to look at this [Data Science Roadmap](http://nirvacana.com/thoughts/wp-content/uploads/2013/07/RoadToDataScientist1.png) (we covered the mustard coloured part) and read this [Field Guide to Data Science](https://www.boozallen.com/content/dam/boozallen/documents/2015/12/2015-FIeld-Guide-To-Data-Science.pdf). Since there's so much going on the world of machine learning and artificial intelligence right now, you might also want to look up each of the companies listed in this [Machine Learning Landscape](https://format-com-cld-res.cloudinary.com/image/private/s--LpKDjJvM--/c_crop,h_1500,w_2000,x_0,y_0/c_fill,g_center,h_855,w_1140/a_auto,fl_keep_iptc.progressive,q_95/v1/19575bcc040a6dcff3097618ec9c585e/MI-Landscape-3_7.png).

But most importantly, if you take away one thing away from this course, let it be this:
